...
\heading{Disclosure.}
We notified the authors of the MKPM work~\cite{MKPMC} and the maintainers of Meta's PrivateID repository~\cite{} on \ff{insert date}, sharing our findings and a preprint of this work.
