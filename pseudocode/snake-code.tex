 		...
 		\cmmnt{Store locations of linked identifiers.}\\
 			\pcfor i = 0, \dots, n-1 \pcdo \\
				\t	\loc[\hbx_i[j^*]] \gets i \pcskipln\\
 				\cmmnt{Find start index $\ell$ of the linked list.} \\
 				...
 				i \gets 0 \\
				\pcwhile \hbx_{\ell}[k] \in \loc \pcdo\label{lin:snake_recover_dowhile}\\
 				\t	\bs_i \gets \hbx_{\ell} \label{lin:snake_recover_assign_t_star}\\
 				\t	\ell \gets \loc[\hbx_\ell[k]] \label{lin:snake_recover_updt_c}\\
