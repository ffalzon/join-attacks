...
\begin{figure}
	...
	The record matching logic \match{} is defined in Figure~\ref{fig:match_logic}.\label{fig:MKPM}}
\end{figure}
...
That is, we sample an injective random function $f_C : \Ispace{} \to \calG$, which we call a "hiding function",
...
After that, a new hiding function $f_P : \Ispace{} \to \calG$ is sampled and used to hide the identifiers in $\calC''$.
