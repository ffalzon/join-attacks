...
where $A = X$, $B = Y$ for the \PSUCAattack{} attack and $A = \Ispace[T]$, $B = \Ispace[Y]$ for the \mkpsiattack{} attack.
Limiting the number of queries, we now have $\posSet \subseteq A \cap B$ and $\negSet \subseteq A \setminus B$.
We discuss three metrics: 
