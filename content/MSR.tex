...
\begin{figure}
    ...
    % }
	%}
	\caption{Result of preprocessing a set of records in $\snakeattack$. Observe that the first attribute is unique across all records.
...
Figure~\ref{fig:snake_exmp} for a small example of the adversary's input.
