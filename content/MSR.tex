...
The attack requires only one query and therefore establishes a tight lower bound on the number of queries needed to achieve MSR (Definition~\ref{def:max_recons}).
