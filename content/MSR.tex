...
flattens the target set $T$ into an input $X$ consisting of a single record $\br$ that
...
The pseudocode of \baselineattack{} is shown in Figure~\ref{fig:toy_attack} (left).  
...
Correctness of the attack directly follows
...
\begin{figure}
	...
	\end{pchstack}
	\caption{Baseline attack with oracle access to the MKPM functionality with leakage $\calF_{\LMKPM}(\cdot, Y)$. 
