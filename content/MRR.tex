...
\begin{figure}
  ...
  \caption{Example of that $\PSUCAattack{}$ attack cannot be applied to the
    output of $\calF_{\MKPM}(T;Y)$. Lines between records indicate potential
    matches based on matching values. Solid lines denote the matched records
