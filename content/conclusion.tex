\section{Discussion}
\heading{Extensions.} \tianxin{What should we include here?} Following the
two-party join work \cite{}, multi-party \cite{} and designated-party \cite{}
...
analysis. \tianxin{Is it standard join instead?}
