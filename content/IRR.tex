...
Starting at the root, the adversary traverses the tree top-down, selecting a node at each step and querying $\calF_{\LMKPM}$ on that node’s associated subset of records. Let $X$ be a set associated with a node in the tree and $X_1$ and $X_2$ be those of its children.
