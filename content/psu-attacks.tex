...
The complete attack \PSUattack{} is described in \Cref{fig:PSU_attack}. Correctness of the attack follows directly from \Cref{eqn:PSU_basis} and Propositions~\ref{prop:PSU_difference_distributes} and \ref{prop:PSU_comp_partial_difference}.
% \begin{theorem}
