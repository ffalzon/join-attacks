...
target set $X$, which may evaluate $\PSUCA(X'; Y) = |X' \cap Y|$ for arbitrarily
...
\begin{figure}
  ...
  {	\colorlet{positive}{LimeGreen}
    ...
    \caption{
      ...
      {\color{positive} green} for elements in $X\cap Y$
