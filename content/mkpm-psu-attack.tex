...
The adversary is given a target set of records $T \subseteq \Ispace{}^n$, and can evaluate $\calF_{\MKPM}(X, Y)$ for arbitrarily many inputs $X$, while the recovery set $Y$ remains static. Its goal is to determine the set of matchable records, $T \sqcap Y$.
