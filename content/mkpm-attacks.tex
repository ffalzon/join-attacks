...
The authors of MK-PrivateID \cite{MKPMC} acknowledge the existence of their protocol’s leakage but deem it acceptable as an aggregate metric that would only cause concern across multiple executions. We contradict this by presenting three attacks that achieve Maximum Set Reconstruction with only a single protocol invocation.
