...
In the previous chapter, we presented an attack that exploits the leakage of the MK-PrivateID protocol to 
recover the set of identifiers which occur in both the target and the victim set 
without changing the statistical distribution of the protocol inputs (compared to honest protocol executions).
In this chapter, we show how deviating from this restriction 
