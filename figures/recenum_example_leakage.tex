...
\begin{tikzpicture}
	...
	% Nodes
	\node[block=\minwidthid, draw=none] (eve_idx) {$2:$};
	...
	\node[block=\minwidthid,below=\rowspace of eve_idx, draw=none ] (bob_idx) {$1:$};
	...
	\node[block=\minwidthid,below=\rowspace of bob_idx, draw=none ] (gus_idx) {$3:$};
	...
	\node[block=\minwidthid,below=\rowspace of gus_idx, draw=none ] (alice_idx) {$0:$};
