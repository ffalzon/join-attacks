\begin{tikzpicture}[
    ...
    node distance=0, >=Stealth
]

% Nodes
\node[block=\minwidthid, draw=none ] (alice_idx) {$0:$};
\node[block=\minwidthid,fill=matched-light, right=\linecorr of alice_idx] (alice1) {$\id_0$};
\node[block=\minwidthid,fill=matched-light, right=\linecorr of alice1] (alice2) {$\id_0$};
...
\node[block=\minwidthid, draw=none, below=\rowspace of alice_idx] (bob_idx) {$1:$};
\node[block=\minwidthid,fill=trow-light, right=\linecorr of bob_idx] (bob1) {$\id_0$};
\node[block=\minwidthid,fill=trow-light, right=\linecorr of bob1] (bob2) {$\id_1$};
...
\node[block=\minwidthid,below=\rowspace of bob_idx, draw=none ] (eve_idx) {$2:$};
\node[block=\minwidthid,fill=trow-dark, right=\linecorr of eve_idx] (eve1) {$\id_1$};
\node[block=\minwidthid,fill=trow-dark, right=\linecorr of eve1] (eve2) {$\id_0$};
...
\node[block=\minwidthid,below=\rowspace of eve_idx, draw=none ] (gus_idx) {$3:$};
\node[block=\minwidthid,fill=trow-light, right=\linecorr of gus_idx] (gus1) {$\id_1$};
\node[block=\minwidthid,fill=tiebreaker, right=\linecorr of gus1] (gus2) {$\id_2$};
