...
\node[block=\minwidthid, fill=trow-dark, right=\linecorr of a11] (a12) {0};
...
\node[block=\minwidthid, fill=trow-dark, right=\linecorr of a31] (a32) {1};
...
\node[block=\minwidthid, fill=trow-dark, right=\linecorr of b11] (b12) {0};

\node[block=\minwidthuid, fill=trow-light, below=\rowspace of b11] (b21) {9349};
\node[block=\minwidthid, fill=trow-light, right=\linecorr of b21] (b22) {1};

\node[block=\minwidthuid, fill=trow-dark, below=\rowspace of b21] (b31) {3042};
\node[block=\minwidthid, fill=trow-dark, right=\linecorr of b31] (b32) {2};
\end{scope}
